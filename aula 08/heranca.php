...
class cachorro extends animal{ //cria a classe "filha" extensão da classe pai "extends"
    private $raca;
    
    public function __construct($especie, $habitat, $sexo, $alimentacao,$raca){
        parent::__construct($especie, $habitat, $sexo, $alimentacao); //parent em portugues pai, deriva os construtores da classe pai
        $this->setRaca($raca);
    }
